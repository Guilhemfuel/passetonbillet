...
return [
    ...
    */
    ...
    'questions' => [
        ...
        [
            'title'   => 'J’ai plusieurs billets sous la même réservation, comment puis-je être certain(e) que l‘acheteur ne va pas utiliser un billet qui différent de celui qu‘il a acheté ?',
            'content' => 'Lorsque vous cliquez sur ‘Vendre billet à X‘, l‘acheteur recevra uniquement le billet unique que vous lui avez vendu et non tous les billets sous la même réservation. Ainsi, il n‘y aucune raison pour laquelle il aurait besoin de se connecter sur le site Eurostar et voir qu‘il y a plusieurs billets sous la même réservation. Donc aucun inquiétude!',
            'tags'    => [
                'choisir',
                'choose',
                'select',
        ...
        [
            ...
            'content' => 'Pour acheter un billet, choisissez le billet qui vous intéresse, soit en utilisant le moteur de recherche de la plateforme, soit en cliquant sur un lien direct de billet.<br> 
        ...
        [
            ...
            'content' => 'Oui, cliquez sur ‘Acheter‘ au centre du billet. Vous pouvez ensuite soit contacter le vendeur directement en cliquant sur ‘Appeler le vendeur‘',
            'tags'    => [
                'contacter',
                'contact',
                'seller',
...
//        ],
        [
            ...
            'content' => 'Lorsque le vendeur aura reçu votre paiement pour son billet, il vous suffit devra impérativement cliquer sur ‘Billet vendu à X’ en haut de la conversation avec vous. Vous recevrez alors automatiquement votre billet par email, et celui-ci sera alors immédiatement retiré de la vente et toutes les conversations avec d’autres acheteurs intéressés par ce billet seront terminées.
