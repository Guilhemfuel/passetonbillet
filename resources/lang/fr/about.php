...
return [
    ...
    */
    ...
    'sub_title' => 'Lastar est la première plate-forme qui vous permet d\'acheter et de vendre rapidement et en toute sécurité des billets Eurostar d\'occasion',

    'safer' => [
        'title' => 'POURQUOI LASTAR EST PLUS SÛR QUE TOUTE AUTRE PLATEFORME D\'ÉCHANGE DE BILLETS',
        'content' => [
            'Grâce à notre algorithme, il est IMPOSSIBLE de vendre un faux ticket sur la plateforme. La seule façon de vendre un billet sur Lastar est d\'entrer un code de réservation Eurostar valide.',
    ...
    'quicker' => [
        ...
        'content' => [
            ...
            'Lorsque vous voulez vendre un billet, la seule chose que vous avez à faire est d\'entrer le code de réservation Eurostar et toutes les informations de votre billet seront automatiquement récupérées. Vous n\'aurez jamais à entrer toutes les informations de ticket manuellement.',
            'Tous les billets Eurostar d\'occasion sont listés sur une seule plateforme au lieu d\'avoir à basculer entre les différentes plateformes d\'échange. Cela garantit également à nos utilisateurs un choix beaucoup plus large.',
    ...
    'cheaper' => [
        ...
        'content' => [
            ...
            'Parce que notre objectif est de rassembler tous les Eurostar d\'occasion disponibles sur une seule plate-forme, vous aurez un choix beaucoup plus large et par conséquent une meilleure opportunité de trouver un billet correspondant à vos critères.',
