...
return [
    ...
    */
    ...
    'sub_title' => 'Lastar is the first platform that allows you to safely and quickly buy and sell second hand Eurostar tickets',

    'safer' => [
        'title' => 'WHY IS LASTAR SAFER THAN ANY OTHER TICKET EXCHANGE PLATFORMS',
        'content' => [
            'Thanks to our algorithm, it is IMPOSSIBLE to sell a fake ticket on the platform. The only way to sell a ticket on Lastar is to enter a valid Eurostar booking code.',
    ...
    'quicker' => [
        ...
        'content' => [
            ...
            'When you want to sell a ticket, the only thing you have to do is to enter the Eurostar booking code and all your ticket information will be retreived automatically. You will never have to enter all the ticket information manually.',
            'All the second-hand Eurostar tickets are listed on one platform only instead of having to switch between the different exchange platforms. This also guarantee our users a much larger choice.',
    ...
    'cheaper' => [
        ...
        'content' => [
            ...
            'Because we aim to gather all the second hand Eurostar available on a single platform, you will have a much broader choice and consequently a better opportunity to find a ticket that you match your criteria.',
